        ...
        switch (ch) {
			...
			break; 	
                ...
                case 'i':
                        ...
                        printf("Enter quantum index to seek to: ");
                        scanf("%d", &q_index);

                        /* lseek to quantum q_index */
                        off_t pos = lseek(fd, (off_t)q_index, SEEK_SET);
                        printf("lseek returned: %ld (= %d * %d = %d)\n", pos, q_index, 4000, q_index * 4000);

                        /* read one quantum worth of data */
                        ...
                        /* print first 20 chars so we can verify */
                        printf("Read %ld bytes from quantum[%d]: %.20s...\n", n, q_index, buf);
                        break;
                //cr
                default:
